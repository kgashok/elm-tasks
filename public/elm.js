...
var author$project$Main$NewCount = function (a) {
	return {$: 'NewCount', a: a};
};
...
var author$project$Main$generateRandom = A2(
	elm$random$Random$generate,
	author$project$Main$NewCount,
	A2(elm$random$Random$int, 1000, 5000));
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{contents: '', count: 500},
		author$project$Main$generateRandom);
};
...
var author$project$Main$Greet = function (a) {
	return {$: 'Greet', a: a};
};
		...
		switch (msg.$) {
			...
			case 'Greet':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'GenerateRandom':
				return _Utils_Tuple2(model, author$project$Main$generateRandom);
			default:
				var val = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$DelayedHello)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Greet')
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Randomize and Greet')
					])),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(model.contents)
					]))
			]));
};
